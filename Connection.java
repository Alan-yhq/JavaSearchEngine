...
public interface Connection {
     ...
     * connection time and the time to read the full response.
     *
     ...
     * Typically just the name, not path, component.
     * @param inputStream the input stream to upload, that you probably obtained
     * from a {@link java.io.FileInputStream}.
     * @param contentType the Content Type (aka mimetype) to specify for this
     * file. You must close the InputStream in a {@code finally} block.
     * @return this Connections, for chaining
     */
    ...
    interface Base<T extends Base> {
        ...
        /**
         * Get the value of a header. If there is more than one header value
         * with the same name, the headers are returned comma seperated, per
         * <a href="https://www.w3.org/Protocols/rfc2616/rfc2616-sec4.html#sec4.2">rfc2616-sec4</a>.
         * <p>
         ...
         * @return a list of values for this header, or an empty list if not
         * set.
         */
         ...
         * same case insensitive name. (If there is more than one value for this
         * header, this method will update the first matching header.
         *
         ...
         * values as a map. For headers with multiple values, only the first
         * header is returned.
         * <p>
         * Note that this is a view of the headers only, and changes made to
         * this map will not be reflected in the request/response object.</p>
         *
         * @return headers
         * @see #multiHeaders()
         *
        ...
        /**
         * Retreive all of the headers, keyed by the header name, and with a
         * list of values per header.
         *
    ...
    interface Response extends Base<Response> {
        ...
        /**
         * Read and parse the body of the response as a Document. If you intend
         * to parse the same response multiple times, you should
         * {@link #bufferUp()} first.
         *
         ...
         * {@link #parse()} may be called repeatedly on the same connection
         * response (otherwise, once the response is read, its InputStream will
         * have been drained and may not be re-read). Calling {@link #body() }
         * or {@link #bodyAsBytes()} has the same effect.
         *
         * @return this response, for chaining
         * @throws UncheckedIOException if an IO exception occurs during
         * buffering.
         */
        Response bufferUp();
         ...
         * close the input stream when you're done with it. Other body methods
         * (like bufferUp, body, parse, etc) will not work in conjunction with
         * this method.
         * <p>
         * This method is useful for writing large responses to disk, without
         * buffering them completely into memory first.</p>
         *
    ...
    interface KeyVal {
         ...
         * uploading files. Only useful if {@link #inputStream(InputStream)} is
         * set.
         * <p>
         * Will default to {@code application/octet-stream}.</p>
         *
