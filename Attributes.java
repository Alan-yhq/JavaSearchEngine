 ...
 * </p>
 * <p>
 * Attribute name and value comparisons are generally <b>case sensitive</b>. By
 * default for HTML, attribute names are normalized to lower-case on parsing.
 * That means you should use lower-case strings when referring to attributes by
 * name.
 * </p>
 *
...
public class Attributes implements Iterable<Attribute>, Cloneable {
     ...
     * @return the attribute value if set; or empty string if not set (or a
     * boolean attribute).
     * @see #hasKey(String)
     */
